        ...
        <div :class="classes">
            ...
            <div :class="[prefixCls + '-header']" v-if="showHeader" ref="header" @mousewheel="handleMouseWheel">
                <table-head
                    ...
                    :data="rebuildData">
                    <template v-slot:column-header-wrap="columnHeaderScope">
                        <slot name="column-header" v-bind="columnHeaderScope"></slot>
                    </template>
                </table-head>
            </div>
...
<script>
    import tableHead from './OTableHeader.vue';
...
//                    const width = this.bodyHeight === 0 ? this.tableWidth : this.tableWidth - this.scrollBarWidth;
        ...
        methods: {
            ...
            handleFilterReset (_index) {
                ...
                /** 追加自定义过滤 开始 */
                if(this.cloneColumns[index]._customFilter) {
                    if (this.cloneColumns[index]._customFilter.filterMethod) {// 还原过滤方法
                        this.cloneColumns[index].filterMethod = this.cloneColumns[index]._customFilter.filterMethod
                    }
                    this.cloneColumns[index]._customFilter = {};
                }
                /** 追加自定义过滤 结束 */
